...
plot(x=-sp_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_pop_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
     type="n",xlim=c(ts,1),ylim=c(0,0.5),xlab="Time (BP)",bty="n",
     ylab="Rate of Change", cex.lab = 1.5)
...
segments(x0=-sp_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_pop_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_pop_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_pop_linear_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_pop_linear_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_pop_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
...
segments(x0=-ex_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_pop_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_pop_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_pop_linear_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_pop_linear_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
...
plot(x=-sp_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_innov_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
     type="n",xlim=c(ts,1),ylim=c(0,0.5),xlab="Time (BP)",bty="n",
     yaxt="n", ylab="",cex.lab = 1.5)
...
segments(x0=-sp_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_innov_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_innov_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="navyblue")
polygon(x=c(-sp_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_innov_linear_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_innov_linear_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_innov_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_innov_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_innov_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_innov_linear_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_innov_linear_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
...
plot(x=-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_trans_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
     type="n",xlim=c(ts,1),ylim=c(0,0.5),xlab="Time (BP)",bty="n",
     yaxt="n", ylab="",
     cex.lab = 1.5)
...
segments(x0=-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_trans_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_trans_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="navyblue")
polygon(x=c(-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_trans_linear_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_trans_linear_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_trans_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_trans_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_trans_linear_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_trans_linear_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_trans_linear_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
...
plot(x=-sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_pop_exponential_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
     type="n",xlim=c(ts,1),ylim=c(0,0.5),xlab="Time (BP)",bty="n",
     ylab="Rate of Change", cex.lab = 1.5)
...
segments(x0=-sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_pop_exponential_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_pop_exponential_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="navyblue")
polygon(x=c(-sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_pop_exponential_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_pop_exponential_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_pop_exponential_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_pop_exponential_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_pop_exponential_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_pop_exponential_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_pop_exponential_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("B1",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_innov_incremental_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
     type="n",xlim=c(ts,1),ylim=c(0,0.5),xlab="Time (BP)",bty="n",
     yaxt="n", ylab="", cex.lab = 1.5)
...
segments(x0=-sp_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_innov_incremental_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_innov_incremental_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="navyblue")
polygon(x=c(-sp_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_innov_incremental_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_innov_incremental_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_innov_incremental_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_innov_incremental_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_innov_incremental_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_innov_incremental_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_innov_incremental_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("B2",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_trans_multiple_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
     type="n",xlim=c(ts,1),ylim=c(0,0.5),xlab="Time (BP)",bty="n",
     yaxt="n", ylab="", cex.lab = 1.5)
...
segments(x0=-sp_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_trans_multiple_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_trans_multiple_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="navyblue")
polygon(x=c(-sp_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_trans_multiple_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_trans_multiple_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_trans_multiple_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_trans_multiple_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_trans_multiple_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_trans_multiple_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_trans_multiple_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
...
plot(x=-sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_pop_logistic_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
     type="n",xlim=c(ts,1),ylim=c(0,0.5),xlab="Time (BP)",bty="n",
     ylab="Rate of Change", cex.lab = 1.5)
...
segments(x0=-sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_pop_logistic_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_pop_logistic_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="navyblue")
polygon(x=c(-sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_pop_logistic_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_pop_logistic_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_pop_logistic_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_pop_logistic_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_pop_logistic_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_pop_logistic_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_pop_logistic_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("C1",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_innov_invention_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
     type="n",xlim=c(ts,1),ylim=c(0,0.5),xlab="Time (BP)",bty="n",
     yaxt="n", ylab="", cex.lab = 1.5)
...
segments(x0=-sp_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_innov_invention_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_innov_invention_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="navyblue")
polygon(x=c(-sp_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_innov_invention_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_innov_invention_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_innov_invention_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_innov_invention_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_innov_invention_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_innov_invention_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_innov_invention_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("C2",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end],
...
lines(x=-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_trans_single_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="navyblue",lty=4,lwd=2)
segments(x0=-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_trans_single_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=sp_rate_ta_trans_single_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="navyblue")
polygon(x=c(-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(sp_rate_ta_trans_single_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(sp_rate_ta_trans_single_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_trans_single_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_trans_single_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5+0.02,
         y1=ex_rate_ta_trans_single_5_samp_.1_rate[ta_lite_start:ta_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
        ...
        y=c(ex_rate_ta_trans_single_5_samp_.1_maxHPD[ta_lite_start:ta_lite_end]/5, 
            rev(ex_rate_ta_trans_single_5_samp_.1_minHPD[ta_lite_start:ta_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
...
lines(x=-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=diversity_ta_trans_linear_5_samp_.1_net_diversity[ta_lite_start:ta_lite_end],
