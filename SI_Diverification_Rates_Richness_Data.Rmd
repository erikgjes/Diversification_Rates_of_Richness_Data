...
|            $b = 0$
|          2 $N = 2000$ 
|            $\mu = 0.05, 0.00875, 0.0125, 0.01625, 0.02$
|            $b = 0$
|          3 $N = 2000$ 
|            $\mu = 0.01$
...
Prior to performing the analysis summarises above, we need to first load in the necessary functions and packages that will be used throughout this analysis. This can be done by sourcing the file from the GitHub repository:

```{r, eval=FALSE,message=FALSE,warning=FALSE}
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/cult_tempo_functions.R")
library(tidyverse)
library(scales)
```
...
pop_sizes <- tibble(timesteps = seq(1, 50, 1)) %>% 
...
innov_rates <- tibble(timesteps = seq(1, 50, 1)) %>% 
...
trans_rates <- tibble(timesteps = seq(1, 50, 1)) %>% 
...
plot(x=seq(1,ts,1),y=seq(N1,N2,length.out = ts),type="n",ylab=expression(paste("Population Size (", N, ")")),xlab="Time",xlim=c(1,50),bty="n",main="Population")
...
plot(x=seq(1,ts,1),y=seq(mu1,mu2,length.out = ts),type="n",ylab=expression(paste("Innovation Rates (", mu, ")")),xlab="Time",xlim=c(1,ts),bty="n",main="Innovation")
...
plot(x=seq(1,ts,1),y=seq(b1,b2,length.out = ts),type="n",ylab=expression(paste("Strength of Frequency Bias (", b, ")")), xlab="Time",xlim=c(1,ts),bty="n",main="Frequency Bias")
...
plot(x=time,y=rowMeans(innov_invention_summary$Richness),type="n",
     xlim=c(1,ts),ylim=c(0,260),
     ylab='Number of Cultural Variants (Richness)',xlab="Time",bty="n",main="")
apply(pop_linear_summary$Richness,MAR=2,lines,
      col=alpha("black",0.02),lwd=1,x=seq(1,50,by=1))
apply(innov_linear_summary$Richness,MAR=2,lines,
      col=alpha("grey20",0.02),lwd=1,x=seq(1,50,by=1))
apply(trans_linear_summary$Richness,MAR=2,lines,
      col=alpha("grey40",0.02),lwd=1,x=seq(1,50,by=1))
...
apply(innov_incremental_summary$Richness,MAR=2,lines,
      col=alpha("grey20",0.02),lwd=1,x=seq(1,ts,by=1))
apply(trans_multiple_summary$Richness,MAR=2,lines,
      col=alpha("grey60",0.02),lwd=1,x=seq(1,ts,by=1))
...
apply(pop_logistic_summary$Richness,MAR=2,lines,
      col=alpha("black",0.04),lwd=1,x=seq(1,ts,by=1))
apply(innov_invention_summary$Richness,MAR=2,lines,
      col=alpha("grey20",0.04),lwd=1,x=seq(1,ts,by=1))
apply(trans_single_summary$Richness,MAR=2,lines,
      col=alpha("grey60",0.04),lwd=1,x=seq(1,ts,by=1))
...
`python3 LiteRateForward.py -d pop_linear_r454.txt`
...
`python3 LiteRateForward.py -d pop_linear_r454.txt -n 5000000 -s 5000`
...
`python3 plot_RJforward_files.py ./pop_linear/literate_mcmc_logs/ -burnin 0.2 -combine 1`  
`python3 plot_RJforward_files.py ./pop_exponential/literate_mcmc_logs/  -burnin 0.2 -combine 1`  
`python3 plot_RJforward_files.py ./pop_logistic/literate_mcmc_logs/ -burnin 0.2 -combine 1`  

`python3 plot_RJforward_files.py ./innov_linear/literate_mcmc_logs/  -burnin 0.2 -combine 1`  
`python3 plot_RJforward_files.py ./innov_incremental/literate_mcmc_logs/  -burnin 0.2 -combine 1` 
`python3 plot_RJforward_files.py ./innov_invention/literate_mcmc_logs/  -burnin 0.2 -combine 1`  

`python3 plot_RJforward_files.py ./trans_linear/literate_mcmc_logs/  -burnin 0.2 -combine 1`  
`python3 plot_RJforward_files.py ./trans_multiple/literate_mcmc_logs/  -burnin 0.2 -combine 1`  
`python3 plot_RJforward_files.py ./trans_single/literate_mcmc_logs/  -burnin 0.2 -combine 1`  
...
#Scenario A
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/pop_linear_combined_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/innov_linear_combined_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/trans_linear_combined_raw.r")
...
#Scenario B
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/pop_exponential_combined_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/innov_incremental_combined_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/trans_multiple_combined_raw.r")
...
#Scenario C
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/pop_logistic_combined_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/innov_invention_combined_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/complete_data/trans_single_combined_raw.r")
...
```{r, eval=FALSE, message=FALSE}
#Scenario A
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_pop_linear_5_samp_.1_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_innov_linear_5_samp_.1_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_trans_linear_5_samp_.1_raw.r")
...
#Scenario B
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_pop_exponential_5_samp_.1_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_innov_incremental_5_samp_.1_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_trans_multiple_5_samp_.1_raw.r")
...
#Scenario C
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_pop_logistic_5_samp_.1_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_innov_invention_5_samp_.1_raw.r")
source("https://raw.githubusercontent.com/erikgjes/Diversification_Rates_of_Richness_Data/master/incomplete_data/ta_trans_single_5_samp_.1_raw.r")
...
plot(x=-sp_rate_pop_linear_time[lite_start:lite_end],
     y=sp_rate_pop_linear_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n", 
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_pop_linear_time[lite_end:lite_start],
      y=sp_rate_pop_linear_rate[rate_lite_end:rate_lite_start],col="navyblue")
polygon(x=c(-sp_rate_pop_linear_time[lite_start:lite_end],
            rev(-sp_rate_pop_linear_time[lite_start:lite_end])), 
        y=c(sp_rate_pop_linear_maxHPD[rate_lite_start:rate_lite_end], 
            rev(sp_rate_pop_linear_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_pop_linear_time[lite_start:lite_end],
      y=ex_rate_pop_linear_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_pop_linear_time[lite_start:lite_end],
            rev(-ex_rate_pop_linear_time[lite_start:lite_end])), 
        y=c(ex_rate_pop_linear_maxHPD[rate_lite_start:rate_lite_end], 
            rev(ex_rate_pop_linear_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_pop_linear_mids,sp_rate_pop_linear_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_pop_linear_mids[lite_start:lite_end],
         ...
         y1=sp_rate_pop_linear_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_pop_linear_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_pop_linear_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Population (A1)",cex=1.5,side=3,line=1,at=-10)

plot(x=-sp_rate_innov_linear_time[lite_start:lite_end],
     y=sp_rate_innov_linear_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_innov_linear_time[lite_start:lite_end],
      y=sp_rate_innov_linear_rate[rate_lite_start:rate_lite_end],col="navyblue")
polygon(x=c(-sp_rate_innov_linear_time[lite_start:lite_end],
            rev(-sp_rate_innov_linear_time[lite_start:lite_end])), 
        y=c(sp_rate_innov_linear_maxHPD[rate_lite_start:rate_lite_end],
            rev(sp_rate_innov_linear_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_innov_linear_time[lite_start:lite_end],
      y=ex_rate_innov_linear_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_innov_linear_time[lite_start:lite_end],
            rev(-ex_rate_innov_linear_time[lite_start:lite_end])), 
        y=c(ex_rate_innov_linear_maxHPD[rate_lite_start:rate_lite_end],
            rev(ex_rate_innov_linear_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_innov_linear_mids,sp_rate_innov_linear_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_innov_linear_mids[lite_start:lite_end],
         ...
         y1=sp_rate_innov_linear_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_innov_linear_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_innov_linear_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Innovation (A2)",cex=1.5,side=3,line=1,at=-10)

plot(x=-sp_rate_trans_linear_time[lite_start:lite_end],
     y=sp_rate_trans_linear_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_trans_linear_time[lite_start:lite_end],
      y=sp_rate_trans_linear_rate[rate_lite_start:rate_lite_end],col="navyblue")
polygon(x=c(-sp_rate_trans_linear_time[lite_start:lite_end],
            rev(-sp_rate_trans_linear_time[lite_start:lite_end])), 
        y=c(sp_rate_trans_linear_maxHPD[rate_lite_start:rate_lite_end], 
            rev(sp_rate_trans_linear_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_trans_linear_time[lite_start:lite_end],
      y=ex_rate_trans_linear_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_trans_linear_time[lite_start:lite_end],
            rev(-ex_rate_trans_linear_time[lite_start:lite_end])), 
        y=c(ex_rate_trans_linear_maxHPD[rate_lite_start:rate_lite_end], 
            rev(ex_rate_trans_linear_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_trans_linear_mids,sp_rate_trans_linear_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_trans_linear_mids[lite_start:lite_end],
         ...
         y1=sp_rate_trans_linear_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_trans_linear_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_trans_linear_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Frequency-Bias (A3)",cex=1.5,side=3,line=1,at=-8)
...
plot(x=-sp_rate_pop_exponential_time[lite_start:lite_end],
     y=sp_rate_pop_exponential_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n", 
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_pop_exponential_time[lite_end:lite_start],
      y=sp_rate_pop_exponential_rate[rate_lite_end:rate_lite_start],col="navyblue")
polygon(x=c(-sp_rate_pop_exponential_time[lite_start:lite_end],
            rev(-sp_rate_pop_exponential_time[lite_start:lite_end])), 
        y=c(sp_rate_pop_exponential_maxHPD[rate_lite_start:rate_lite_end], 
            rev(sp_rate_pop_exponential_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_pop_exponential_time[lite_start:lite_end],
      y=ex_rate_pop_exponential_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_pop_exponential_time[lite_start:lite_end],
            rev(-ex_rate_pop_exponential_time[lite_start:lite_end])), 
        y=c(ex_rate_pop_exponential_maxHPD[rate_lite_start:rate_lite_end], 
            rev(ex_rate_pop_exponential_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_pop_exponential_mids,sp_rate_pop_exponential_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_pop_exponential_mids[lite_start:lite_end],
         ...
         y1=sp_rate_pop_exponential_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_pop_exponential_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_pop_exponential_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Population (B1)",cex=1.5,side=3,line=1,at=-10)

plot(x=-sp_rate_innov_incremental_time[lite_start:lite_end],
     y=sp_rate_innov_incremental_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_innov_incremental_time[lite_start:lite_end],
      y=sp_rate_innov_incremental_rate[rate_lite_start:rate_lite_end],col="navyblue")
polygon(x=c(-sp_rate_innov_incremental_time[lite_start:lite_end],
            rev(-sp_rate_innov_incremental_time[lite_start:lite_end])), 
        y=c(sp_rate_innov_incremental_maxHPD[rate_lite_start:rate_lite_end],
            rev(sp_rate_innov_incremental_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_innov_incremental_time[lite_start:lite_end],
      y=ex_rate_innov_incremental_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_innov_incremental_time[lite_start:lite_end],
            rev(-ex_rate_innov_incremental_time[lite_start:lite_end])), 
        y=c(ex_rate_innov_incremental_maxHPD[rate_lite_start:rate_lite_end],
            rev(ex_rate_innov_incremental_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_innov_incremental_mids,sp_rate_innov_incremental_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_innov_incremental_mids[lite_start:lite_end],
         ...
         y1=sp_rate_innov_incremental_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_innov_incremental_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_innov_incremental_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Innovation (B2)",cex=1.5,side=3,line=1,at=-10)

plot(x=-sp_rate_trans_multiple_time[lite_start:lite_end],
     y=sp_rate_trans_multiple_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_trans_multiple_time[lite_start:lite_end],
      y=sp_rate_trans_multiple_rate[rate_lite_start:rate_lite_end],col="navyblue")
polygon(x=c(-sp_rate_trans_multiple_time[lite_start:lite_end],
            rev(-sp_rate_trans_multiple_time[lite_start:lite_end])), 
        y=c(sp_rate_trans_multiple_maxHPD[rate_lite_start:rate_lite_end], 
            rev(sp_rate_trans_multiple_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_trans_multiple_time[lite_start:lite_end],
      y=ex_rate_trans_multiple_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_trans_multiple_time[lite_start:lite_end],
            rev(-ex_rate_trans_multiple_time[lite_start:lite_end])), 
        y=c(ex_rate_trans_multiple_maxHPD[rate_lite_start:rate_lite_end], 
            rev(ex_rate_trans_multiple_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_trans_multiple_mids,sp_rate_trans_multiple_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_trans_multiple_mids[lite_start:lite_end],
         ...
         y1=sp_rate_trans_multiple_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_trans_multiple_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_trans_multiple_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Frequency-Bias (B3)",cex=1.5,side=3,line=1,at=-8)
...
plot(x=-sp_rate_pop_logistic_time[lite_start:lite_end],
     y=sp_rate_pop_logistic_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n", 
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_pop_logistic_time[lite_end:lite_start],
      y=sp_rate_pop_logistic_rate[rate_lite_end:rate_lite_start],col="navyblue")
polygon(x=c(-sp_rate_pop_logistic_time[lite_start:lite_end],
            rev(-sp_rate_pop_logistic_time[lite_start:lite_end])), 
        y=c(sp_rate_pop_logistic_maxHPD[rate_lite_start:rate_lite_end], 
            rev(sp_rate_pop_logistic_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_pop_logistic_time[lite_start:lite_end],
      y=ex_rate_pop_logistic_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_pop_logistic_time[lite_start:lite_end],
            rev(-ex_rate_pop_logistic_time[lite_start:lite_end])), 
        y=c(ex_rate_pop_logistic_maxHPD[rate_lite_start:rate_lite_end], 
            rev(ex_rate_pop_logistic_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_pop_logistic_mids,sp_rate_pop_logistic_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_pop_logistic_mids[lite_start:lite_end],
         ...
         y1=sp_rate_pop_logistic_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_pop_logistic_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_pop_logistic_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Population (C1)",cex=1.5,side=3,line=1,at=-10)

plot(x=-sp_rate_innov_invention_time[lite_start:lite_end],
     y=sp_rate_innov_invention_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_innov_invention_time[lite_start:lite_end],
      y=sp_rate_innov_invention_rate[rate_lite_start:rate_lite_end],col="navyblue")
polygon(x=c(-sp_rate_innov_invention_time[lite_start:lite_end],
            rev(-sp_rate_innov_invention_time[lite_start:lite_end])), 
        y=c(sp_rate_innov_invention_maxHPD[rate_lite_start:rate_lite_end],
            rev(sp_rate_innov_invention_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_innov_invention_time[lite_start:lite_end],
      y=ex_rate_innov_invention_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_innov_invention_time[lite_start:lite_end],
            rev(-ex_rate_innov_invention_time[lite_start:lite_end])), 
        y=c(ex_rate_innov_invention_maxHPD[rate_lite_start:rate_lite_end],
            rev(ex_rate_innov_invention_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_innov_invention_mids,sp_rate_innov_invention_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_innov_invention_mids[lite_start:lite_end],
         ...
         y1=sp_rate_innov_invention_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_innov_invention_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_innov_invention_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Innovation (C2)",cex=1.5,side=3,line=1,at=-10)

plot(x=-sp_rate_trans_single_time[lite_start:lite_end],
     y=sp_rate_trans_single_rate[rate_lite_start:rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates",cex.lab = 1)
lines(x=-sp_rate_trans_single_time[lite_start:lite_end],
      y=sp_rate_trans_single_rate[rate_lite_start:rate_lite_end],col="navyblue")
polygon(x=c(-sp_rate_trans_single_time[lite_start:lite_end],
            rev(-sp_rate_trans_single_time[lite_start:lite_end])), 
        y=c(sp_rate_trans_single_maxHPD[rate_lite_start:rate_lite_end], 
            rev(sp_rate_trans_single_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_trans_single_time[lite_start:lite_end],
      y=ex_rate_trans_single_rate[rate_lite_start:rate_lite_end],col="firebrick",lwd=2)
polygon(x=c(-ex_rate_trans_single_time[lite_start:lite_end],
            rev(-ex_rate_trans_single_time[lite_start:lite_end])), 
        y=c(ex_rate_trans_single_maxHPD[rate_lite_start:rate_lite_end], 
            rev(ex_rate_trans_single_minHPD[rate_lite_start:rate_lite_end])), 
        col = alpha("firebrick",0.3), border = NA)

plot(sp_rate_trans_single_mids,sp_rate_trans_single_counts,xlim=c(1,ts),
     ylim=c(0,0.5),xlab="Time", type="n",bty="n",
     ylab="Proportion of RJMCMC Generations",cex.lab = 1)
segments(x0=-sp_rate_trans_single_mids[lite_start:lite_end],
         ...
         y1=sp_rate_trans_single_counts[rate_lite_start:rate_lite_end],lwd=2,col="navyblue")
segments(x0=-ex_rate_trans_single_mids[lite_start:lite_end]+0.25,
         ...
         y1=ex_rate_trans_single_counts[rate_lite_start:rate_lite_end],lwd=2,col="firebrick")
abline(h=bf2,lty=2)
abline(h=bf6,lty=2)
mtext("Frequency-Bias (C3)",cex=1.5,side=3,line=1,at=-8)
...
```{r, eval=FALSE}
ta_lite_start = 1 #As noted above, due to some lingering edge effects in LiteRate, the first data point is not plotted
ta_lite_end = 10

ta_rate_lite_start = 10
ta_rate_lite_end = 1

png("Figure_6_Time_Samp.png",width = 10, height = 10, units = 'in', res = 300)
...
plot(x=-sp_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_pop_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates", cex.lab = 1)
...
segments(x0=-sp_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_pop_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_pop_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_pop_linear_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_pop_linear_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_pop_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
...
segments(x0=-ex_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_pop_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_pop_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_pop_linear_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_pop_linear_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("A1",cex=1.5,side=3,line=-2,at=25)
mtext("Population",cex=1.5,side=3,line=1,at=25)


plot(x=-sp_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_innov_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",yaxt="n",
     ylab="", cex.lab = 1)
...
segments(x0=-sp_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_innov_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_innov_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_innov_linear_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_innov_linear_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_innov_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_innov_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_innov_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_innov_linear_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_innov_linear_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("A2",cex=1.5,side=3,line=-2,at=25)
mtext("Innovation",cex=1.5,side=3,line=1,at=25)


plot(x=-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_trans_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",yaxt="n",
     ylab="", cex.lab = 1)
...
segments(x0=-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_trans_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_trans_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_trans_linear_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_trans_linear_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_trans_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_trans_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_trans_linear_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_trans_linear_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_trans_linear_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("A3",cex=1.5,side=3,line=-2,at=25)
mtext("Frequency-Bias",cex=1.5,side=3,line=1,at=25)


plot(x=-sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_pop_exponential_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates", cex.lab = 1)
...
segments(x0=-sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_pop_exponential_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_pop_exponential_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_pop_exponential_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_pop_exponential_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_pop_exponential_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_pop_exponential_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_pop_exponential_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_pop_exponential_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_pop_exponential_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("B1",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_innov_incremental_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",yaxt="n",
     ylab="", cex.lab = 1)
...
segments(x0=-sp_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_innov_incremental_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_innov_incremental_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_innov_incremental_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_innov_incremental_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_innov_incremental_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_innov_incremental_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_innov_incremental_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_innov_incremental_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_innov_incremental_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("B2",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_trans_multiple_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",yaxt="n",
     ylab="", cex.lab = 1)
...
segments(x0=-sp_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_trans_multiple_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_trans_multiple_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_trans_multiple_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_trans_multiple_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_trans_multiple_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_trans_multiple_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_trans_multiple_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_trans_multiple_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_trans_multiple_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("B3",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_pop_logistic_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",
     ylab="Origination and Extinction Rates", cex.lab = 1)
...
segments(x0=-sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_pop_logistic_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_pop_logistic_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_pop_logistic_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_pop_logistic_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_pop_logistic_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_pop_logistic_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_pop_logistic_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_pop_logistic_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_pop_logistic_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("C1",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_innov_invention_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",yaxt="n",
     ylab="", cex.lab = 1)
...
segments(x0=-sp_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_innov_invention_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_innov_invention_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_innov_invention_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_innov_invention_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_innov_invention_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_innov_invention_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_innov_invention_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_innov_invention_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_innov_invention_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("C2",cex=1.5,side=3,line=-2,at=25)

plot(x=-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=sp_rate_ta_trans_single_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
     type="n",xlim=c(1,ts),ylim=c(0,0.5),xlab="Time",bty="n",yaxt="n",
     ylab="", cex.lab = 1)
...
segments(x0=-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=sp_rate_ta_trans_single_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=sp_rate_ta_trans_single_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,col="navyblue")
polygon(x=c(-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(sp_rate_ta_trans_single_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(sp_rate_ta_trans_single_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("navyblue",0.3), border = NA)
lines(x=-ex_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=ex_rate_ta_trans_single_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5,
      col="firebrick",lty=4,lwd=2)
segments(x0=-ex_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
         ...
         y0=ex_rate_ta_trans_single_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5+0.02,
         y1=ex_rate_ta_trans_single_5_samp_.1_rate[ta_rate_lite_start:ta_rate_lite_end]/5-0.02,
         col="firebrick")
polygon(x=c(-ex_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
            rev(-ex_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end])*5), 
        y=c(ex_rate_ta_trans_single_5_samp_.1_maxHPD[ta_rate_lite_start:ta_rate_lite_end]/5, 
            rev(ex_rate_ta_trans_single_5_samp_.1_minHPD[ta_rate_lite_start:ta_rate_lite_end]/5)), 
        col = alpha("firebrick",0.3), border = NA)
mtext("C3",cex=1.5,side=3,line=-2,at=25)


dev.off()
```

```{r,eval=TRUE,out.height="100%",out.width="100%",message=FALSE,echo=FALSE,fig.align="left"}
knitr::include_graphics("Figure_6_Time_Samp.png")
```
...
png("Figure_S1_TA_Samp_Richness.png",width = 6, height = 10, units = "in", res = 300)
par(mfrow=c(3,1))
par(mar=c(4.1,4.1,4.1,1.1))

#Scenario A
plot(x=sp_rate_ta_pop_linear_5_samp_.1_time[ta_lite_start:ta_lite_end],
     y=diversity_ta_pop_linear_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,50),xlab="Time",bty="n",
...
lines(x=-sp_rate_ta_innov_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=diversity_ta_innov_linear_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
      col="grey20",lty=2,lwd=2)
lines(x=-sp_rate_ta_trans_linear_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=diversity_ta_trans_linear_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
      col="grey40",lty=3,lwd=2)
mtext(side=2,line=-2,at=50,"A",las=2,cex=1.5)

#Scenario B
plot(x=sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end],
     y=diversity_ta_pop_exponential_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,50),xlab="Time",bty="n",
     ylab="Number of Cultural Variants (Richness)",
     cex.lab = 1.5)
lines(x=-sp_rate_ta_pop_exponential_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      ...
      col="black",lty=1,lwd=2)
lines(x=-sp_rate_ta_innov_incremental_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=diversity_ta_innov_incremental_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
      col="grey20",lty=2,lwd=2)
lines(x=-sp_rate_ta_trans_multiple_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=diversity_ta_trans_multiple_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
      col="grey40",lty=3,lwd=2)
mtext(side=2,line=-2,at=50,"B",las=2,cex=1.5)

#Scenario C
plot(x=sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end],
     y=diversity_ta_pop_logistic_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
     type="n",xlim=c(1,ts),ylim=c(0,50),xlab="Time",bty="n",
     ylab="Number of Cultural Variants (Richness)",
     cex.lab = 1.5)
lines(x=-sp_rate_ta_pop_logistic_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      ...
      col="black",lty=1,lwd=2)
lines(x=-sp_rate_ta_innov_invention_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=diversity_ta_innov_invention_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
      col="grey20",lty=2,lwd=2)
lines(x=-sp_rate_ta_trans_single_5_samp_.1_time[ta_lite_start:ta_lite_end]*5,
      y=diversity_ta_trans_single_5_samp_.1_net_diversity[ta_rate_lite_start:ta_rate_lite_end],
      col="grey40",lty=3,lwd=2)
...
```{r,eval=TRUE,out.height="100%",out.width="100%",message=FALSE,echo=FALSE,fig.align="left"}
knitr::include_graphics("Figure_S1_TA_Samp_Richness.png")
```
